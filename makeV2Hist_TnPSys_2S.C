...
void makeV2Hist_TnPSys_2S(int cLow = 0, int cHigh = 20,
                float ptLow = 0, float ptHigh = 3, 
                float yLow = 0, float yHigh=2.4,
                float SiMuPtCut = 3.5, float massLow = 8, float massHigh =14, bool isMC = false, bool dimusign=true, bool fAccW = true, bool fEffW = true, int hfSel =0, int fMuId = 1, int fInnTrk = 0, int fTrig = 0, int state=2)
{
  //Basic Setting
  gStyle->SetOptStat(0);
  setTDRStyle();
