...
void makeV2Hist_2S(int cLow = 20, int cHigh = 180,
                float ptLow = 0, float ptHigh = 50, 
                float yLow = 0, float yHigh=2.4,
                float SiMuPtCut = 3.5, float massLow = 8, float massHigh =14, bool isMC = false, bool dimusign=true, bool fAccW = true, bool fEffW = true, int hfSel =-1)
{
  //Basic Setting
  gStyle->SetOptStat(0);
  setTDRStyle();
  ...
  TString fDIR = mainDIR + "/plots/MassV2Hist2S";
  ...
  TFile *fEff = new TFile(Form("/home/deathold/work/CMS/analysis/Upsilon_v2/UpsilonPbPb2018_v2/Efficiency/mc_eff_vs_pt_TnP%d_PtW%d_OfficialMC_Y2S_muPtCut3.5.root",isTnP,isEffPtWeight),"read");
  TH1D* hEffPt[3];
  ...
  TFile *fAcc;
  if(isAccPtWeight) fAcc = new TFile("/home/deathold/work/CMS/analysis/Upsilon_v2/UpsilonPbPb2018_v2/Acceptance/acceptance_wgt_2S_pt0_50_20190813_dNdptWeighted.root","read");
  else if(!isAccPtWeight) fAcc = new TFile("/home/deathold/work/CMS/analysis/Upsilon_v2/UpsilonPbPb2018_v2/Acceptance/acceptance_wgt_2S_pt0_50_20190813_nonweighted.root","read");
  TH1D* hAccPt = (TH1D*) fAcc -> Get("hptAccNoW2S"); 
