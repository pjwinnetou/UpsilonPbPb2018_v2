...
Double_t TotalYield(Double_t* x, Double_t* par)
{
  ...
  Ups1S_2 = 1/(sigma1_2*TMath::Sqrt(2*TMath::Pi()))*exp(-0.5*U1S_t2*U1S_t2);
  Ups2S_2 = 1/(sigma2_2*TMath::Sqrt(2*TMath::Pi()))*exp(-0.5*U2S_t2*U2S_t2);
  Ups3S_2 = 1/(sigma3_2*TMath::Sqrt(2*TMath::Pi()))*exp(-0.5*U3S_t2*U3S_t2);
  ...
  Double_t SigM = N1*(fN1s_1*frac*Ups1S_1 + (1-frac)*Ups1S_2) + N2*(fN2s_1*frac*Ups2S_1 + (1-frac)*Ups2S_2) + N3*(fN3s_1*frac*Ups3S_1 + (1-frac)*Ups3S_2);
...
Double_t Totalvnpol2U1S2S3S(Double_t* x, Double_t* par)
{
  ...
  Ups1S_2 = 1/(sigma1S_2*TMath::Sqrt(2*TMath::Pi()))*exp(-0.5*U1S_t2*U1S_t2);
  Ups2S_2 = 1/(sigma2S_2*TMath::Sqrt(2*TMath::Pi()))*exp(-0.5*U2S_t2*U2S_t2);
  Ups3S_2 = 1/(sigma3S_2*TMath::Sqrt(2*TMath::Pi()))*exp(-0.5*U3S_t2*U3S_t2);
  ...
  Double_t SigM = N1*(fN1s_1*frac*Ups1S_1 + (1-frac)*Ups1S_2) + N2*(fN2s_1*frac*Ups2S_1 + (1-frac)*Ups2S_2) + N3*(fN3s_1*frac*Ups3S_1 + (1-frac)*Ups3S_2);
  Double_t SigM1s = N1*(fN1s_1*frac*Ups1S_1 + (1-frac)*Ups1S_2);
  Double_t SigM2s = N2*(fN2s_1*frac*Ups2S_1 + (1-frac)*Ups2S_2);
  Double_t SigM3s = N3*(fN3s_1*frac*Ups3S_1 + (1-frac)*Ups3S_2);
  Double_t BkgM = Nbkg*(TMath::Exp(-x[0]/Bkgp0)*(TMath::Erf((x[0]-Bkgmean)/(TMath::Sqrt(2)*Bkgsigma))+1)/2.);
...
void doSimultaneousV2MassFit_CBGaus_pt050_cent1090_AllState(int cLow = 20, int cHigh = 180,
...
//}}}
  ...
  TFile *wf = new TFile(Form("%s/SimFitResult_CBGaus_%s.root",fDIR.Data(),kineLabel.Data()),"recreate");
...
*/
  ...
  v2plot->SetPoint(1,ptar,v2_2s);
  v2plot->SetPointError(1,1,v2e_2s);
  v2plot->SetPoint(2,ptar,v2_3s);
  v2plot->SetPointError(2,2,v2e_3s);
  v2plot->SetTitle("");
