#include <iostream>
#include "/home/deathold/work/CMS/analysis/Upsilon_v2/upsilonV2/rootFitHeaders.h"
...
#include "/home/deathold/work/CMS/analysis/Upsilon_v2/upsilonV2/PsetCollection.h"
#include "/home/deathold/work/CMS/analysis/Upsilon_v2/upsilonV2/CMS_lumi_massPull.C"
...
void doFitUpsilon_Data_CBGaus_pt03(
       ...
       bool fixParameters=0  )
{
  ...
  RooRealVar    sigma1s_1("sigma1s_1","width/sigma of the signal gaussian mass DF",0.01, 0.01, 0.2);
  ...
  RooRealVar alpha1s_1("alpha1s_1","tail shift", 2.222 , 1.426, 4.531);
  ...
  RooRealVar n1s_1("n1s_1","power order", 2.205 , 1.3302, 4.345);
...
//  pullFrame->GetYaxis()->SetLimits(-6,6) ;
 ...
 // pullFrame->GetYaxis()->SetTitleFont(43);
  ...
  TFile* outf = new TFile(Form("fitRes/CBGaus/fitresults_upsilon_CBGaus_%s.root",kineLabel.Data()),"recreate");
  outh->Write();
  c1->SaveAs(Form("fitRes/CBGaus/fitresults_upsilon_CBGaus_%s.pdf",kineLabel.Data()));
  c1->Write();
  ws->Write();
