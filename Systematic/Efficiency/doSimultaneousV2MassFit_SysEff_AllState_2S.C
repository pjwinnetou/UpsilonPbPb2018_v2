...
void doSimultaneousV2MassFit_SysEff_AllState_2S(int cLow = 20, int cHigh = 180,
...
//}}}
  ...
  TFile* rf = new TFile(Form("/home/deathold/work/CMS/analysis/Upsilon_v2/UpsilonPbPb2018_v2/plots/MassV2Hist2SEffSys/Ups_%s_AccW1_EffW1.root",kineLabel.Data()),"read");
  TH1D* h_v2_SplusB = (TH1D*) rf->Get("h_v2_SplusB");  
  TGraphAsymmErrors* g_mass = (TGraphAsymmErrors*) rf->Get("g_mass");  

  TFile *wf = new TFile(Form("%s/SimFitResult_SysEff_%s_2S.root",fDIR.Data(),kineLabel.Data()),"recreate");
  ...
  //Read Signal File
  TFile *sfile = new TFile(Form("/home/deathold/work/CMS/analysis/Upsilon_v2/UpsilonPbPb2018_v2/MassFit/AllParmFreeFit/fitRes/fitresults_2S_upsilon_DoubleCB_pt%.1f-%.1f_y%.1f-%.1f_muPt3.5_centrality0-180.root",ptLow,ptHigh,yLow,yHigh),"read");
  sfile->cd();
...
/*
  ...
  */
  ...
  pad1->Draw();
  pad2->Draw();
  c_mass_v2->SaveAs(Form("%s/v2Mass_SysEff_%s_2S.pdf",fDIR.Data(),kineLabel.Data()));
/*
  Double_t xmass[200];
