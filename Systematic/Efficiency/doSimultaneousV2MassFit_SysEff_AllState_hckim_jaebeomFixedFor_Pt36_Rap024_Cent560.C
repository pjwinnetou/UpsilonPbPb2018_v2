...
void doSimultaneousV2MassFit_SysEff_AllState_hckim_jaebeomFixedFor_Pt36_Rap024_Cent560(int cLow = 10, int cHigh = 120,
                     float ptLow = 3, float ptHigh = 6,
...
//Make directory{{{
	...
	TString fDIR = mainDIR + "/FitResultv2EffSys";
...
//###  TFile* rf = new TFile(Form("/afs/cern.ch/work/h/hckim/cms1032_yv2_v3Guillaume_20190718/src/UpsilonPbPb2018_v2/plots/MassV2Hist/hckim/Ups_%s_AccW1_EffW1.root",kineLabel.Data()),"read");
  TFile* rf = new TFile(Form("../../plots/MassV2Hist/hckimEffSys/Ups_%s_AccW1_EffW1.root",kineLabel.Data()),"read");
...
//  TFile *sfile = new TFile(Form("../../Acceptance/v201908/fitresults_upsilon_DoubleCB_pt%.1f-%.1f_y%.1f-%.1f_muPt3.5_centrality0-180.root",ptLow,ptHigh,yLow,yHigh),"read");
...
//  Double_t parLimitLow[nParmV]  = {     0,     -2,     -2,        0, mean_ -0.02, 0.00,  0.0,  0.0, 0, 0, par0[10]*0.5,  par0[11]*0.5, par0[12]*0.5, -0.3, -0.4, -0.4, -3, -3, -3, -2};
//  Double_t parLimitHigh[nParmV] = {N1_*10, N2_*10, N3_*10, Nbkg_*10, mean_ +0.02,  0.5, 10.0, 10.0, 1, 1, par0[10]*2.5,  par0[11]*2.5, par0[12]*2.5,  0.3,  0.4,  0.4,  3,  3,  3,  2};
  Double_t parLimitLow[nParmV]  = {     0,     -2,   -200,        0, mean_ -0.02, 0.00,  0.0,  0.0, 0, 0, par0[10]*low10sf,  par0[11]*low11sf, par0[12]*low12sf, -0.3, -0.4, -1.2, -1, -3, -3, -2};
  Double_t parLimitHigh[nParmV] = {N1_*10, N2_*10, N3_*10, Nbkg_*10, mean_ +0.02,  0.5, 10.0, 10.0, 1, 1, par0[10]*high10sf,  par0[11]*high11sf, par0[12]*high12sf,  0.3,  0.4,  1.2,  1,  3,  3,  2};
