...
root -l -b <<EOF
.L doSimultaneousV2MassFit_SysAcc_AllState_2S_hckim.C++
.q
EOF
rm *.so *.d *.pcm
...
root -l -q -b 'doSimultaneousV2MassFit_SysAcc_AllState_2S_hckim.C(20,180,0,50,'$rap','$SiMuPtCut','$mBin',true,fpol2,'$low10sf','$low11sf','$low12sf','$high10sf','$high11sf','$high12sf'+3.0,'$c_','$c1_','$c2_','$c3_')'
...
#        for mBin in '8,14'
#        do
# 			  root -l -q -b 'doSimultaneousV2MassFit_SysAcc_AllState_2S_hckim.C('$cBin','$pt','$rap','$SiMuPtCut','$mBin',true,fpol2)'
#        done
#      done
#    done
#  done
