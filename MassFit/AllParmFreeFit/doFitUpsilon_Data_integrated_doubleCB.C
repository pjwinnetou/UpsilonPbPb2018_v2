...
void doFitUpsilon_Data_integrated_doubleCB(
...
//  pullFrame->GetYaxis()->SetLimits(-6,6) ;
 ...
 // pullFrame->GetYaxis()->SetTitleFont(43);
  ...
  TFile* outf = new TFile(Form("fitRes/Folder5/fitresults_upsilon_DoubleCB_%s.root",kineLabel.Data()),"recreate");
  outh->Write();
  c1->SaveAs(Form("fitRes/Folder5/fitresults_upsilon_DoubleCB_%s.pdf",kineLabel.Data()));
  c1->Write();
  ws->Write();
