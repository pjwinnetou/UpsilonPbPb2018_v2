#include <iostream>
#include "/work1/hwan/tools/2019/CMS/UpsilonPbPb2018_v2/rootFitHeaders.h"
#include "/work1/hwan/tools/2019/CMS/UpsilonPbPb2018_v2/commonUtility.h"
...
#include "TArrow.h"
#include "TFile.h"
#include "/work1/hwan/tools/2019/CMS/UpsilonPbPb2018_v2/cutsAndBinUpsilonV2.h"
#include "/work1/hwan/tools/2019/CMS/UpsilonPbPb2018_v2/PsetCollection.h"
#include "/work1/hwan/tools/2019/CMS/UpsilonPbPb2018_v2/CMS_lumi_massPull.C"
#include "/work1/hwan/tools/2019/CMS/UpsilonPbPb2018_v2/tdrstyle.C"
#include "/work1/hwan/tools/2019/CMS/UpsilonPbPb2018_v2/Style_jaebeom.h"

using namespace std;
using namespace RooFit;
void doFitUpsilon_Data_integrated_CBGaus(
       ...
       bool fixParameters=0  )
{
  ...
  TFile* f1 = new TFile("/work1/hwan/tools/2019/CMS/UpsilonPbPb2018_v2/skimmedFiles/OniaTree_Skim_UpsTrig_190710.root");
  ...
  RooRealVar n1s_1("n1s_1","power order", 2.405 , 1.002, 4.845);
...
/*  if ( initPset.n1s_1 == -1 )
  ...
  RooGaussian* cb1s_2 = new RooGaussian("gaus1s", "Gaussain", *(ws->var("mass")), mean1s, sigma1s_2);
  RooGaussian* cb2s_2 = new RooGaussian("gaus2s", "Gaussain", *(ws->var("mass")), mean2s, sigma2s_2);
  RooGaussian* cb3s_2 = new RooGaussian("gaus3s", "Gaussain", *(ws->var("mass")), mean3s, sigma3s_2);
...
//  pullFrame->GetYaxis()->SetLimits(-6,6) ;
 ...
 // pullFrame->GetYaxis()->SetTitleFont(43);
  ...
  TFile* outf = new TFile(Form("fitRes/Folder5/fitresults_upsilon_CBGaus_%s.root",kineLabel.Data()),"recreate");
  outh->Write();
  c1->SaveAs(Form("fitRes/Folder5/fitresults_upsilon_CBGaus_%s.pdf",kineLabel.Data()));
  c1->Write();
  ws->Write();
