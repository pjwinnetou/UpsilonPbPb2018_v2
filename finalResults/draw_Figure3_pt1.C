...
void draw_Figure3_pt1(){
  ...
  gv2 = (TGraphErrors*)fIn->Get("gr_point_v2_vs_pt_Cent010");
  ...
  gsys = (TGraphErrors*)fIn->Get("gr_sys_v2_vs_pt_Cent010");
  ...
  globtex->DrawLatex(0.23, sz_init-sz_step, Form("Cent. 0-10%s",perc.Data()));
  ...
  final_v2_g->SetName("gr_point_v2_vs_pt_Cent010");
  CMS_lumi_square( c1, iPeriod, iPos );
  c1->Update();
  c1->SaveAs("v2Sig_pt_Cent_1.pdf");
