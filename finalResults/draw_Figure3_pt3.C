...
void draw_Figure3_pt3(){
  ...
  gv2 = (TGraphErrors*)fIn->Get("gr_point_v2_vs_pt_Cent3050");
  ...
  gsys = (TGraphErrors*)fIn->Get("gr_sys_v2_vs_pt_Cent3050");
  ...
  globtex->DrawLatex(0.23, sz_init-sz_step, Form("Cent. 30-50%s",perc.Data()));
