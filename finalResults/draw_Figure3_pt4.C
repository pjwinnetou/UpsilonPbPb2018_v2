...
void draw_Figure3_pt4(){
  ...
  gv2 = (TGraphErrors*)fIn->Get("gr_point_v2_vs_pt_Cent5090");
  ...
  gsys = (TGraphErrors*)fIn->Get("gr_sys_v2_vs_pt_Cent5090");
  ...
  globtex->DrawLatex(0.23, sz_init-sz_step, Form("Cent. 50-90%s",perc.Data()));
